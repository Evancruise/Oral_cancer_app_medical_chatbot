      ...
      <tr>
        ...
        <td>
          <button type="button" class="view_btn btn btn-sm btn-primary" name="view_btn"
                  ...
                  data-f-img7="${r.img7 ?? ''}"
                  data-f-img8="${r.img8 ?? ''}"
                  data-f-img1_result="${r.img1_result ?? ''}"
                  data-f-img2_result="${r.img2_result ?? ''}"
                  data-f-img3_result="${r.img3_result ?? ''}"
                  data-f-img4_result="${r.img4_result ?? ''}"
                  data-f-img5_result="${r.img5_result ?? ''}"
                  data-f-img6_result="${r.img6_result ?? ''}"
                  data-f-img7_result="${r.img7_result ?? ''}"
                  data-f-img8_result="${r.img8_result ?? ''}">
            查看
          </button>
        </td>
      </tr>`;
